...
import { FaPlus, FaClock, FaSyncAlt, FaBars } from 'react-icons/fa';
    ...
    <div className='text-black px-4 sm:px-6 lg:px-8'>
      ...
      <div className='mx-auto py-4'>
        <div className='flex justify-between items-center gap-x-4 text-nowrap'>
          <h1 className='text-lg sm:text-xl font-bold mb-7 sm:tracking-normal tracking-tighter'>
            CNAPP Dashboard
          </h1>
          <div className='flex items-center gap-x-4 sm:text-base text-sm sm:overflow-hidden overflow-x-scroll scrollbar-hidden scroll-mr-3'>
            ...
            >
              Add Widget<FaPlus className='sm:ml-2 ml-1 text-gray-500' />
               ...
               <div className='flex items-center gap-x-4 sm:text-base text-sm sm:overflow-hidden overflow-x-scroll scrollbar-hidden scroll-mr-3'>
               <button className="bg-white rounded-lg sm:pl-5 pl-6 sm:pr-4 pr-1 py-1.5 outline-none ring-inset ring-2 ring-blue-300 focus:ring-blue-500 active:bg-blue-100">
